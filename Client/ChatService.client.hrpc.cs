...
public class ChatServiceClient
{
    ...
    // unary QueryHasPermission
    public async Task<Protocol.Chat.V1.QueryHasPermissionResponse> QueryHasPermission(Protocol.Chat.V1.QueryHasPermissionRequest pm)
        => await _client.HrpcUnaryAsync<Protocol.Chat.V1.QueryHasPermissionRequest, Protocol.Chat.V1.QueryHasPermissionResponse>(_host + "/protocol.chat.v1.ChatService/QueryHasPermission", pm);
